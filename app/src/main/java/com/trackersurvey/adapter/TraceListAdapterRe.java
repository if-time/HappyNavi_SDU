...
public class TraceListAdapterRe extends RecyclerView.Adapter<TraceListAdapterRe.TraceViewHolder> {
    ...
    public class TraceViewHolder extends RecyclerView.ViewHolder {
        ...
        public TraceViewHolder(View itemView) {
            super(itemView);
            traceTpyeIv = (ImageView) itemView.findViewById(R.id.trace_type_iv);
            isLocalIv = (ImageView) itemView.findViewById(R.id.is_local_iv);
            isCloudIv = (ImageView) itemView.findViewById(R.id.is_cloud_iv);
            traceNameTv = (TextView) itemView.findViewById(R.id.trace_name_tv);
            startTimeTv = (TextView) itemView.findViewById(R.id.start_time_tv);
            distanceTv = (TextView) itemView.findViewById(R.id.distance_tv);
            durationTv = (TextView) itemView.findViewById(R.id.duration_tv);
            stepCountTv = (TextView) itemView.findViewById(R.id.step_tv);
            stepLabelTv = (TextView) itemView.findViewById(R.id.step_label_tv);
            poiNumTv = (TextView) itemView.findViewById(R.id.poi_num_tv);
            selectCb = (CheckBox) itemView.findViewById(R.id.select_trace_cb);
            view = itemView;
        }
    }
