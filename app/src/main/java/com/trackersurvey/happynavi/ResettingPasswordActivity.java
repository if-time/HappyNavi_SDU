...
import com.trackersurvey.http.ResettingPasswordRequest;
...
//                } else
                    ...
                    ResettingPasswordRequest registerRequest = new ResettingPasswordRequest(uid, pwdMD5.toUpperCase());
                    ...
                    Log.i("Resetting", inputPhone.getText().toString() + "_" + inputPassword.getText().toString());
                }
                break;
