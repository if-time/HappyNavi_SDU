...
public class UserInfoActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userHeadIv = (RoundImageView) findViewById(R.id.user_info_head_img);
        nicknameTv = (TextView) findViewById(R.id.user_info_nickname);
        realNameTv = (TextView) findViewById(R.id.user_info_real_name);
        userIdTv = (TextView) findViewById(R.id.user_info_id);
        ...
        Button changeInfoBtn = (Button) findViewById(R.id.change_user_info_btn);
        Button changePwdBtn = (Button) findViewById(R.id.change_password_btn);
