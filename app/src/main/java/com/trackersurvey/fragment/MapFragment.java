...
public class MapFragment extends Fragment implements View.OnClickListener, LocationSource, AMapLocationListener,
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        changeSportTypeIb = (ImageButton) homepageLayout.findViewById(R.id.change_sport_type_ib); // 改变运动状态
        takePhoto = (ImageButton) homepageLayout.findViewById(R.id.imgbtn_takephoto);
        endTrail = (ImageButton) homepageLayout.findViewById(R.id.imgbtn_endtrail);
    ...
    public void endTrail() {
        ...
        locationService.setTraceID(0);
        locationService.changeStatus(false); // 改为非记录状态
        Log.i("dongpsDataIsOnline", "endTrail: " + termtraceID);
     ...
     * @return
     */
    public boolean gpsDataIsOnline(final long traceID) {
        ...
        downloadTraceDetail.requestHttpData(new ResponseData() {
            ...
            public void onResponseData(boolean isSuccess, String code, Object responseObject, String msg) throws IOException {
                if (isSuccess) {
                    ...
                    List<GpsData> tracegps = (List<GpsData>) responseObject;
                    if (tracegps.size() <= 0) {
                        getLocalGPSData(traceID);
                        Log.i("dongpsDataIsOnline", "onResponseData:  + racegps.size() <= 0 " + code);
                    }
     ...
     * 从本地获取GPSData
     */
    private boolean getLocalGPSData(long traceID) {
        // 从本地获取
