...
//        initView();
        ...
        titleTv = (TextView) questionnaireLayout.findViewById(R.id.title_text);
        titleTv.setText(getResources().getString(R.string.questionnaire));
        titleBack = (RelativeLayout) questionnaireLayout.findViewById(R.id.title_back_layout);
    ...
    public void init(){
        ...
        webview = (WebView) questionnaireLayout.findViewById(R.id.question_web_view);
        //settings.setDisplayZoomControls(false);
        //settings.setDomStorageEnabled(true);
        refresh = (TextView) questionnaireLayout.findViewById(R.id.title_right_text);
